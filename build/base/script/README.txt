...
make.pkg project package [version]

Description:

Create a self-installing software package. The project and package name are given by "project" and "package" respectively. The optional "version" specifies which version of the package should be created.
...
Create a self-installing version of a master package. The project and package name are given by "project" and "package" respectively. A master package contains the most up to date version of the software and includes the associated software repository.
